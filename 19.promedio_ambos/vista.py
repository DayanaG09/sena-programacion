...
class VistaOperacion:
    ...
    def obtenerDatos(self):
        ...
        self.ventana.config(bg= "#dceeb1", height=500, width=500 ) 
        ...
        label2.config(bg="#fef9f6", relief="raised")
        label2.pack(pady=10)
        ##entry SEGUNDO NUM
        ...
        self.buttonCalculador.config(bg="#fef9f6", relief="raised")
...
#Utilice isdigit para comprobar si el nuevo valor es un número o si el campo está vacío (permitiendo la eliminación de caracteres).
    def mostrarDatos(self, rta):
        ...
        labelRta=tk.Label(self.ventana, text=f"EL PROMEDIO DE LOS DOS NUMEROS ES  :{rta[2]}")
        labelRta.config(bg="#fef9f6", relief="raised")
